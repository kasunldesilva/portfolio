  ...
  return (
    <section className='hero-container'>
        <div className="hero-content">
            <h2>Hi, I'm <strong>Kasun Lakmal</strong></h2>
            ...
            <p>
                <a href="/assets/files/HKdeSilva_Resum.pdf" download>
        ...
        <div className="hero-img">
            ...
            <div>
                <a href="https://www.linkedin.com/in/kasun-lakmal-de-silva" target="_blank" rel="noopener noreferrer" className="tech-icon">
